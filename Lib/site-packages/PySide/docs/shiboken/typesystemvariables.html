...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>5. Type System Variables &mdash; Shiboken 1.2.2 documentation</title>
...
<a class="reference internal" href="#return-type"><span>%RETURN_TYPE</span></a> variable.
Example:</p>
<blockquote>
<div><div class="highlight-c++"><div class="highlight"><pre><span class="kt">void</span> <span class="nf">argRemoval</span><span class="p">(</span><span class="kt">int</span> <span class="n">a0</span><span class="p">,</span> <span class="kt">int</span> <span class="n">a1</span> <span class="o">=</span> <span class="mi">123</span><span class="p">);</span>
</pre></div>
...
the <a class="reference internal" href="#type"><span>%TYPE</span></a> variable, for this latter may be translated to the original
...
<blockquote>
<div>This variable is used only on <a class="reference internal" href="codeinjectionsemantics.html#codeinjecting-method-native"><span>native method code injections</span></a>, i.e. on the binding overrides for C++ virtual
...
Must match with a <a class="reference internal" href="#endallowthreads"><span>%END_ALLOW_THREADS</span></a> variable.</div></blockquote>
<p id="endallowthreads"><strong>%END_ALLOW_THREADS</strong></p>
<blockquote>
<div>Replaced by a thread state restoring procedure.
Must match with a <a class="reference internal" href="#beginallowthreads"><span>%BEGIN_ALLOW_THREADS</span></a> variable.</div></blockquote>
