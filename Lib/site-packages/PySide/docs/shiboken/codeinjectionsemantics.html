...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>7. Code Injection Semantics &mdash; Shiboken 1.2.2 documentation</title>
...
<div class="header">
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="contents.html">Shiboken 1.2.2 documentation</a> &raquo;</li> 
      </ul>
    </div>
    </div>
</div>
...
<p>This is the <code class="docutils literal"><span class="pre">inject-code</span></code> tag options that matters to Shiboken.</p>
<blockquote>
...
<dd>This is a possible value for the <code class="docutils literal"><span class="pre">class</span></code> attribute of the <code class="docutils literal"><span class="pre">inject-code</span></code>
tag, it means things more akin to the C++ side.</dd>
<dt><strong>Target</strong></dt>
<dd>Another <code class="docutils literal"><span class="pre">class</span></code> attribute value, it indicates things more close to the
Python side.</dd>
</dl>
</div>
...
<p>The following table describes the semantics of <code class="docutils literal"><span class="pre">inject-code</span></code> tag as used on
Shiboken.</p>
<blockquote>
...
<td>beginning</td>
<td>Write to the beginning of a class wrapper <code class="docutils literal"><span class="pre">.cpp</span></code> file, right
after the <code class="docutils literal"><span class="pre">#include</span></code> clauses. A common use would be to write
prototypes for custom functions whose definitions are put on a
<code class="docutils literal"><span class="pre">native/end</span></code> code injection.</td>
</tr>
<tr class="row-odd"><td>end</td>
<td>Write to the end of a class wrapper <code class="docutils literal"><span class="pre">.cpp</span></code> file. Could be
used to write custom/helper functions definitions for
prototypes declared on <code class="docutils literal"><span class="pre">native/beginning</span></code>.</td>
</tr>
<tr class="row-even"><td rowspan="2">target</td>
<td>beginning</td>
<td>Put custom code on the beginning of the wrapper initializer
function (<code class="docutils literal"><span class="pre">init_CLASS(PyObject</span> <span class="pre">*module)</span></code>). This could be
used to manipulate the <code class="docutils literal"><span class="pre">PyCLASS_Type</span></code> structure before
registering it on Python.</td>
</tr>
<tr class="row-odd"><td>end</td>
<td>Write the given custom code at the end of the class wrapper
initializer function (<code class="docutils literal"><span class="pre">init_CLASS(PyObject</span> <span class="pre">*module)</span></code>). The
...
(<code class="docutils literal"><span class="pre">PyCLASS_METHOD(...)</span></code>), right after the decisor have found
which signature to call and also after the conversion of the
arguments to be used, but before the actual call.</td>
</tr>
<tr class="row-odd"><td>end</td>
<td>This code is injected on the Python method wrapper
(<code class="docutils literal"><span class="pre">PyCLASS_METHOD(...)</span></code>), right after the C++ method call,
...
<td rowspan="2">native</td>
<td>beginning</td>
<td>Write code to the beginning of the module <code class="docutils literal"><span class="pre">.cpp</span></code> file, right
after the <code class="docutils literal"><span class="pre">#include</span></code> clauses. This position has a similar
purpose as the <code class="docutils literal"><span class="pre">native/beginning</span></code> position on a wrapper
class <code class="docutils literal"><span class="pre">.cpp</span></code> file, namely write function prototypes, but not
restricted to this use.</td>
</tr>
<tr class="row-odd"><td>end</td>
<td>Write code to the end of the module <code class="docutils literal"><span class="pre">.cpp</span></code> file. Usually
implementations for function prototypes inserted at the
beginning of the file with a <code class="docutils literal"><span class="pre">native/beginning</span></code> code
injection.</td>
</tr>
<tr class="row-even"><td rowspan="2">target</td>
<td>beginning</td>
<td>Insert code at the start of the module initialization function
(<code class="docutils literal"><span class="pre">initMODULENAME()</span></code>), before the calling <code class="docutils literal"><span class="pre">Py_InitModule</span></code>.</td>
</tr>
<tr class="row-odd"><td>end</td>
<td>Insert code at the end of the module initialization function
(<code class="docutils literal"><span class="pre">initMODULENAME()</span></code>), but before the checking that emits a
...
<p>From the C++ class, Shiboken will generate a <code class="docutils literal"><span class="pre">injectcode_wrapper.cpp</span></code> file
...
method <code class="docutils literal"><span class="pre">METHOD(ARG)</span></code> is modified to be used from Python as <code class="docutils literal"><span class="pre">METHOD()</span></code>;
...
not write any call to the method and expect the <code class="docutils literal"><span class="pre">modify-function</span> <span class="pre">-</span> <span class="pre">target/beginning</span></code>
code injection to call the original C++ method on its own terms. If even this
custom code is not provided the generator will put an <code class="docutils literal"><span class="pre">#error</span></code> clause to
...
binding developer must use the template variable <code class="docutils literal"><span class="pre">%FUNCTION_NAME</span></code> instead
...
own <code class="docutils literal"><span class="pre">beginning</span></code> and <code class="docutils literal"><span class="pre">end</span></code> code injections.</p>
<blockquote>
...
<p>Those injections go in the body of the <code class="docutils literal"><span class="pre">CLASSNAME_wrapper.cpp</span></code> file for the
wrapped class.</p>
<blockquote>
...
them and also one extra <code class="docutils literal"><span class="pre">MODULENAME_module_wrapper.cpp</span></code> to register the whole
module. Code injection xml tags who have the <code class="docutils literal"><span class="pre">typesystem</span></code> tag as parent will
be put on this file.</p>
<div class="section" id="id3">
<h3>7.6.1. On The Native Side<a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<p>This works exactly as the class wrapper code injections <a class="reference internal" href="#codeinjecting-classes-native"><span>On The Native Side</span></a>.</p>
</div>
<div class="section" id="id4">
<h3>7.6.2. On The Target Side<a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h3>
<p>This is very similar to class wrapper code injections <a class="reference internal" href="#codeinjecting-classes-target"><span>On The Target Side</span></a>.
Notice that the inject code at <code class="docutils literal"><span class="pre">target/end</span></code> is inserted before the check for errors
