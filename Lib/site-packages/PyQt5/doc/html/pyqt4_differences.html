...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Differences Between PyQt4 and PyQt5 &mdash; PyQt 5.1.1 Reference Guide</title>
...
<div class="section" id="qtxml-module">
<h2><tt class="docutils literal"><span class="pre">QtXml</span></tt> Module<a class="headerlink" href="#qtxml-module" title="Permalink to this headline">¶</a></h2>
<p>PyQt4&#8217;s <tt class="docutils literal"><span class="pre">QtXml</span></tt> module is not supported.  Use either the
<tt class="xref py py-class docutils literal"><span class="pre">QXMLStreamReader</span></tt> and
<tt class="xref py py-class docutils literal"><span class="pre">QXMLStreamWriter</span></tt> classes or Python&#8217;s standard XML
modules.</p>
</div>
...
<p>PyQt5 always calls <tt class="xref py py-func docutils literal"><span class="pre">sip.setdestroyonexit()</span></tt> automatically.</p>
</div>
</div>
...
<li><a class="reference internal" href="#qtxml-module"><tt class="docutils literal"><span class="pre">QtXml</span></tt> Module</a></li>
