...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Installing PyQt5 &mdash; PyQt 5.1.1 Reference Guide</title>
    ...
    <link rel="next" title="Differences Between PyQt4 and PyQt5" href="pyqt4_differences.html" />
  ...
  <div class="section" id="installing-pyqt5">
...
The <tt class="file docutils literal"><span class="pre">configurations</span></tt> directory contains configuration files for a
number of target devices.</p>
</dd></dl>
...
<tt class="descname">--consolidate</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-configure.py--consolidate" title="Permalink to this definition">¶</a></dt>
<dd><p>Normally each PyQt5 module (except for the <a class="reference internal" href="introduction.html#module-PyQt5.Qt" title="PyQt5.Qt"><tt class="xref py py-mod docutils literal"><span class="pre">Qt</span></tt></a> module) is
...
minimising the memory footprint of the PyQt5 modules.</p>
</dd></dl>
...
<tt class="descname">--vendorid</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-configure.py--vendorid" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#cmdoption-configure.py--vendorid-libdir"><em class="xref std std-option">--vendorid-libdir</em></a> options and <a class="reference internal" href="deploy_commercial.html#ref-deploy-commercial"><em>Deploying Commercial PyQt5 Applications</em></a>.</p>
</dd></dl>

<dl class="cmdoption">
<dt id="cmdoption-configure.py--vendorid-incdir">
<tt class="descname">--vendorid-incdir</tt><tt class="descclassname"> &lt;DIR&gt;</tt><a class="headerlink" href="#cmdoption-configure.py--vendorid-incdir" title="Permalink to this definition">¶</a></dt>
...
<tt class="descname">--vendorid-libdir</tt><tt class="descclassname"> &lt;DIR&gt;</tt><a class="headerlink" href="#cmdoption-configure.py--vendorid-libdir" title="Permalink to this definition">¶</a></dt>
...
without any problems so long as they are built with the same versions of SIP.</p>
</div>
</div>
  ...
  <ul>
<li><a class="reference internal" href="#">Installing PyQt5</a><ul>
<li><a class="reference internal" href="#downloading-sip">Downloading SIP</a></li>
<li><a class="reference internal" href="#downloading-pyqt5">Downloading PyQt5</a></li>
<li><a class="reference internal" href="#configuring-pyqt5">Configuring PyQt5</a></li>
<li><a class="reference internal" href="#building-pyqt5">Building PyQt5</a></li>
<li><a class="reference internal" href="#co-existence-with-pyqt4">Co-existence with PyQt4</a></li>
</ul>
</li>
</ul>
  ...
  <p class="topless"><a href="pyqt4_differences.html"
                        title="next chapter">Differences Between PyQt4 and PyQt5</a></p>
