...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Support for QVariant &mdash; PyQt 5.1.1 Reference Guide</title>
...
<p>PyQt5 does not support the <tt class="docutils literal"><span class="pre">QPyNullVariant</span></tt> class as it is no longer needed.</p>
  ...
  <p class="topless"><a href="pyqt_qsettings.html"
                        title="next chapter">Support for <tt class="docutils literal docutils literal"><span class="pre">QSettings</span></tt></a></p>
