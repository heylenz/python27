...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Support for Qt Properties &mdash; PyQt 5.1.1 Reference Guide</title>
    ...
    <link rel="prev" title="Support for Signals and Slots" href="signals_slots.html" /> 
  </head>
  <body>
    <div class="related">
      <h3>Navigation</h3>
      <ul>
        ...
        <li class="right" >
          <a href="signals_slots.html" title="Support for Signals and Slots"
...
<p>PyQt5 does not support the setting and getting of Qt properties as if they were
...
<p>However, PyQt5 does support the initial setting of properties using keyword
arguments passed when an instance is created.  For example:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">act</span> <span class="o">=</span> <span class="n">QAction</span><span class="p">(</span><span class="s">&quot;&amp;Save&quot;</span><span class="p">,</span> <span class="bp">self</span><span class="p">,</span> <span class="n">shortcut</span><span class="o">=</span><span class="n">QKeySequence</span><span class="o">.</span><span class="n">Save</span><span class="p">,</span>
...
signal to a slot.</p>
<p>PyQt5 also supports setting the values of properties (and connecting a signal
to a slot) using the <tt class="xref py py-meth docutils literal"><span class="pre">pyqtConfigure()</span></tt> method.  For
example, the following gives the same results as above:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">act</span> <span class="o">=</span> <span class="n">QAction</span><span class="p">(</span><span class="s">&quot;&amp;Save&quot;</span><span class="p">,</span> <span class="bp">self</span><span class="p">)</span>
<span class="n">act</span><span class="o">.</span><span class="n">pyqtConfigure</span><span class="p">(</span><span class="n">shortcut</span><span class="o">=</span><span class="n">QKeySequence</span><span class="o">.</span><span class="n">Save</span><span class="p">,</span>
        <span class="n">statusTip</span><span class="o">=</span><span class="s">&quot;Save the document to disk&quot;</span><span class="p">,</span> <span class="n">triggered</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">save</span><span class="p">)</span>
</pre></div>
</div>
...
<p>A new Qt property may be defined using the <a class="reference internal" href="#PyQt5.QtCore.pyqtProperty" title="PyQt5.QtCore.pyqtProperty"><tt class="xref py py-func docutils literal"><span class="pre">pyqtProperty()</span></tt></a>
...
properties.</p>
<dl class="function">
<dt id="PyQt5.QtCore.pyqtProperty">
<tt class="descclassname">PyQt5.QtCore.</tt><tt class="descname">pyqtProperty</tt><big>(</big><em>type</em><span class="optional">[</span>, <em>fget=None</em><span class="optional">[</span>, <em>fset=None</em><span class="optional">[</span>, <em>freset=None</em><span class="optional">[</span>, <em>fdel=None</em><span class="optional">[</span>, <em>doc=None</em><span class="optional">[</span>, <em>designable=True</em><span class="optional">[</span>, <em>scriptable=True</em><span class="optional">[</span>, <em>stored=True</em><span class="optional">[</span>, <em>user=False</em><span class="optional">[</span>, <em>constant=False</em><span class="optional">[</span>, <em>final=False</em><span class="optional">[</span>, <em>notify=None</em><span class="optional">[</span>, <em>revision=0</em><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt5.QtCore.pyqtProperty" title="Permalink to this definition">¶</a></dt>
...
<li><strong>revision</strong> &#8211; the revision exported to QML.  It is ignored by Python</li>
</ul>
</td>
</tr>
...
<p>It is also possible to use <a class="reference internal" href="#PyQt5.QtCore.pyqtProperty" title="PyQt5.QtCore.pyqtProperty"><tt class="xref py py-func docutils literal"><span class="pre">pyqtProperty()</span></tt></a> as a decorator in
...
<div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">PyQt5.QtCore</span> <span class="kn">import</span> <span class="n">QObject</span><span class="p">,</span> <span class="n">pyqtProperty</span>
...
<li><a class="reference internal" href="#defining-new-qt-properties">Defining New Qt Properties</a></li>
  ...
  <p class="topless"><a href="signals_slots.html"
                        title="previous chapter">Support for Signals and Slots</a></p>
  <h4>Next topic</h4>
