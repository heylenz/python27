...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>DBus Support &mdash; PyQt 5.1.1 Reference Guide</title>
...
<a class="reference internal" href="introduction.html#module-PyQt5.QtDBus" title="PyQt5.QtDBus (UNIX)"><tt class="xref py py-mod docutils literal"><span class="pre">QtDBus</span></tt></a> module provides wrappers for the standard Qt DBus classes.
The <tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.pyqt5</span></tt> module add support for the Qt event loop to the
standard <tt class="docutils literal"><span class="pre">dbus-python</span></tt> Python module.</p>
<div class="section" id="qtdbus">
<h2><a class="reference internal" href="introduction.html#module-PyQt5.QtDBus" title="PyQt5.QtDBus (UNIX)"><tt class="xref py py-mod docutils literal"><span class="pre">QtDBus</span></tt></a><a class="headerlink" href="#qtdbus" title="Permalink to this headline">¶</a></h2>
<p>The <a class="reference internal" href="introduction.html#module-PyQt5.QtDBus" title="PyQt5.QtDBus (UNIX)"><tt class="xref py py-mod docutils literal"><span class="pre">QtDBus</span></tt></a> module is used in a similar way to the C++ library it
...
single <a class="reference internal" href="api/qdbusmessage.html#PyQt5.QtDBus.QDBusMessage" title="PyQt5.QtDBus.QDBusMessage"><tt class="xref py py-class docutils literal"><span class="pre">QDBusMessage</span></tt></a> argument.  The implementation of the
...
<h2><tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.pyqt5</span></tt><a class="headerlink" href="#dbus-mainloop-pyqt5" title="Permalink to this headline">¶</a></h2>
<p>The <tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.pyqt5</span></tt> module provides support for the Qt event loop to
...
loop.</p>
<p>The <tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.pyqt5</span></tt> module contains the following function.</p>
<dl class="function">
...
standard <tt class="docutils literal"><span class="pre">dbus-python</span></tt> language bindings package to be used with PyQt5:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">dbus.mainloop.pyqt5</span> <span class="kn">import</span> <span class="n">DBusQtMainLoop</span>
...
<li><a class="reference internal" href="#dbus-mainloop-pyqt5"><tt class="docutils literal"><span class="pre">dbus.mainloop.pyqt5</span></tt></a></li>
</ul>
</li>
</ul>
