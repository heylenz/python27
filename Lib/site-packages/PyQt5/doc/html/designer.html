...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Using Qt Designer &mdash; PyQt 5.1.1 Reference Guide</title>
    ...
    <link rel="next" title="The PyQt5 Resource System" href="resources.html" />
      ...
      <ul>
        ...
        <li class="right" >
          <a href="py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="resources.html" title="The PyQt5 Resource System"
...
<p>PyQt5 does not wrap the <tt class="docutils literal"><span class="pre">QUiLoader</span></tt> class but instead includes the
<a class="reference internal" href="introduction.html#module-PyQt5.uic" title="PyQt5.uic"><tt class="xref py py-mod docutils literal"><span class="pre">uic</span></tt></a> Python module.  Like <tt class="docutils literal"><span class="pre">QUiLoader</span></tt> this module can load
...
interface.  PyQt5&#8217;s <strong class="program">pyuic5</strong> utility is a command line interface to
the <a class="reference internal" href="introduction.html#module-PyQt5.uic" title="PyQt5.uic"><tt class="xref py py-mod docutils literal"><span class="pre">uic</span></tt></a> module.  Both are described in detail in the following
sections.</p>
...
argument (typically <a class="reference internal" href="api/qdialog.html#PyQt5.QtWidgets.QDialog" title="PyQt5.QtWidgets.QDialog"><tt class="xref py py-class docutils literal"><span class="pre">QDialog</span></tt></a>,
<a class="reference internal" href="api/qwidget.html#PyQt5.QtWidgets.QWidget" title="PyQt5.QtWidgets.QWidget"><tt class="xref py py-class docutils literal"><span class="pre">QWidget</span></tt></a> or <a class="reference internal" href="api/qmainwindow.html#PyQt5.QtWidgets.QMainWindow" title="PyQt5.QtWidgets.QMainWindow"><tt class="xref py py-class docutils literal"><span class="pre">QMainWindow</span></tt></a>) is
set in Designer.  We refer to this type as the <em>Qt base class</em>.</p>
<p>In the following examples we assume that a <tt class="docutils literal"><span class="pre">.ui</span></tt> file has been created
containing a dialog and the name of the <a class="reference internal" href="api/qdialog.html#PyQt5.QtWidgets.QDialog" title="PyQt5.QtWidgets.QDialog"><tt class="xref py py-class docutils literal"><span class="pre">QDialog</span></tt></a>
object is <tt class="docutils literal"><span class="pre">ImageDialog</span></tt>.  We also assume that the name of the file containing
the generated Python code is <tt class="file docutils literal"><span class="pre">ui_imagedialog.py</span></tt>.  The generated code can
then be used in a number of ways.</p>
...
<a class="reference internal" href="api/qdialog.html#PyQt5.QtWidgets.QDialog" title="PyQt5.QtWidgets.QDialog"><tt class="xref py py-class docutils literal"><span class="pre">QDialog</span></tt></a> and set up the user interface in the
<tt class="docutils literal"><span class="pre">__init__()</span></tt> method:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">PyQt5.QtWidgets</span> <span class="kn">import</span> <span class="n">QDialog</span>
<span class="kn">from</span> <span class="nn">ui_imagedialog</span> <span class="kn">import</span> <span class="n">Ui_ImageDialog</span>
...
<span class="k">class</span> <span class="nc">ImageDialog</span><span class="p">(</span><span class="n">QDialog</span><span class="p">):</span>
    <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="nb">super</span><span class="p">(</span><span class="n">ImageDialog</span><span class="p">,</span> <span class="bp">self</span><span class="p">)</span><span class="o">.</span><span class="n">__init__</span><span class="p">()</span>
...
<div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">PyQt5.QtGui</span> <span class="kn">import</span> <span class="n">QDialog</span>
<span class="kn">from</span> <span class="nn">ui_imagedialog</span> <span class="kn">import</span> <span class="n">Ui_ImageDialog</span>
...
<span class="k">class</span> <span class="nc">MyImageDialog</span><span class="p">(</span><span class="n">ImageDialog</span><span class="p">):</span>
    <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="nb">super</span><span class="p">(</span><span class="n">MyImageDialog</span><span class="p">,</span> <span class="bp">self</span><span class="p">)</span><span class="o">.</span><span class="n">__init__</span><span class="p">()</span>
...
<h2>The <a class="reference internal" href="introduction.html#module-PyQt5.uic" title="PyQt5.uic"><tt class="xref py py-mod docutils literal"><span class="pre">uic</span></tt></a> Module<a class="headerlink" href="#the-uic-module" title="Permalink to this headline">¶</a></h2>
<p>The <a class="reference internal" href="introduction.html#module-PyQt5.uic" title="PyQt5.uic"><tt class="xref py py-mod docutils literal"><span class="pre">uic</span></tt></a> module contains the following functions and objects.</p>
<dl class="data">
<dt id="PyQt5.uic.widgetPluginPath">
<tt class="descclassname">PyQt5.uic.</tt><tt class="descname">widgetPluginPath</tt><a class="headerlink" href="#PyQt5.uic.widgetPluginPath" title="Permalink to this definition">¶</a></dt>
...
plugins included with PyQt5.</p>
</dd></dl>

<dl class="function">
<dt id="PyQt5.uic.compileUi">
<tt class="descclassname">PyQt5.uic.</tt><tt class="descname">compileUi</tt><big>(</big><em>uifile</em>, <em>pyfile</em><span class="optional">[</span>, <em>execute=False</em><span class="optional">[</span>, <em>indent=4</em><span class="optional">[</span>, <em>from_imports=False</em><span class="optional">[</span>, <em>resource_suffix='_rc'</em><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt5.uic.compileUi" title="Permalink to this definition">¶</a></dt>
...
from the resource file by <tt class="docutils literal"><span class="pre">pyrcc5</span></tt>.  The default is <tt class="docutils literal"><span class="pre">'_rc'</span></tt>, i.e.
...
<dl class="function">
<dt id="PyQt5.uic.compileUiDir">
<tt class="descclassname">PyQt5.uic.</tt><tt class="descname">compileUiDir</tt><big>(</big><em>dir</em><span class="optional">[</span>, <em>recurse=False</em><span class="optional">[</span>, <em>map=None</em><span class="optional">[</span>, <em>**compileUi_args</em><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt5.uic.compileUiDir" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#PyQt5.uic.compileUi" title="PyQt5.uic.compileUi"><tt class="xref py py-func docutils literal"><span class="pre">compileUi()</span></tt></a> that is called to create each Python
module.</li>
</ul>
</td>
</tr>
...
<dl class="function">
<dt id="PyQt5.uic.loadUiType">
<tt class="descclassname">PyQt5.uic.</tt><tt class="descname">loadUiType</tt><big>(</big><em>uifile</em><span class="optional">[</span>, <em>from_imports=False</em><span class="optional">[</span>, <em>resource_suffix='_rc'</em><span class="optional">]</span><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt5.uic.loadUiType" title="Permalink to this definition">¶</a></dt>
...
<dl class="function">
<dt id="PyQt5.uic.loadUi">
<tt class="descclassname">PyQt5.uic.</tt><tt class="descname">loadUi</tt><big>(</big><em>uifile</em><span class="optional">[</span>, <em>baseinstance=None</em><span class="optional">[</span>, <em>package=''</em><span class="optional">[</span>, <em>resource_suffix='_rc'</em><span class="optional">]</span><span class="optional">]</span><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt5.uic.loadUi" title="Permalink to this definition">¶</a></dt>
...
<h2><strong class="program">pyuic5</strong><a class="headerlink" href="#pyuic5" title="Permalink to this headline">¶</a></h2>
<p>The <strong class="program">pyuic5</strong> utility is a command line interface to the
<a class="reference internal" href="introduction.html#module-PyQt5.uic" title="PyQt5.uic"><tt class="xref py py-mod docutils literal"><span class="pre">uic</span></tt></a> module.  The command has the following syntax:</p>
<div class="highlight-python"><div class="highlight"><pre><span class="n">pyuic5</span> <span class="p">[</span><span class="n">options</span><span class="p">]</span> <span class="o">.</span><span class="n">ui</span><span class="o">-</span><span class="nb">file</span>
</pre></div>
</div>
<p>The full set of command line options is:</p>
<dl class="cmdoption">
<dt id="cmdoption-pyuic5-h">
<tt class="descname">-h</tt><tt class="descclassname"></tt><tt class="descclassname">, </tt><tt class="descname">--help</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-pyuic5-h" title="Permalink to this definition">¶</a></dt>
<dd><p>A help message is written to <tt class="docutils literal"><span class="pre">stdout</span></tt>.</p>
</dd></dl>

<dl class="cmdoption">
<dt id="cmdoption-pyuic5--version">
<tt class="descname">--version</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-pyuic5--version" title="Permalink to this definition">¶</a></dt>
<dd><p>The version number is written to <tt class="docutils literal"><span class="pre">stdout</span></tt>.</p>
</dd></dl>

<dl class="cmdoption">
<dt id="cmdoption-pyuic5-i">
<tt class="descname">-i</tt><tt class="descclassname"> &lt;N&gt;</tt><tt class="descclassname">, </tt><tt class="descname">--indent</tt><tt class="descclassname"> &lt;N&gt;</tt><a class="headerlink" href="#cmdoption-pyuic5-i" title="Permalink to this definition">¶</a></dt>
...
<dl class="cmdoption">
<dt id="cmdoption-pyuic5-o">
<tt class="descname">-o</tt><tt class="descclassname"> &lt;FILE&gt;</tt><tt class="descclassname">, </tt><tt class="descname">--output</tt><tt class="descclassname"> &lt;FILE&gt;</tt><a class="headerlink" href="#cmdoption-pyuic5-o" title="Permalink to this definition">¶</a></dt>
<dd><p>The Python code generated is written to the file <tt class="docutils literal"><span class="pre">&lt;FILE&gt;</span></tt>.</p>
</dd></dl>

<dl class="cmdoption">
<dt id="cmdoption-pyuic5-p">
<tt class="descname">-p</tt><tt class="descclassname"></tt><tt class="descclassname">, </tt><tt class="descname">--preview</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-pyuic5-p" title="Permalink to this definition">¶</a></dt>
<dd><p>The GUI is created dynamically and displayed.  No Python code is generated.</p>
</dd></dl>

<dl class="cmdoption">
<dt id="cmdoption-pyuic5-x">
<tt class="descname">-x</tt><tt class="descclassname"></tt><tt class="descclassname">, </tt><tt class="descname">--execute</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-pyuic5-x" title="Permalink to this definition">¶</a></dt>
...
<dl class="cmdoption">
<dt id="cmdoption-pyuic5--from-imports">
<tt class="descname">--from-imports</tt><tt class="descclassname"></tt><a class="headerlink" href="#cmdoption-pyuic5--from-imports" title="Permalink to this definition">¶</a></dt>
...
<dl class="cmdoption">
<dt id="cmdoption-pyuic5--resource-suffix">
<tt class="descname">--resource-suffix</tt><tt class="descclassname"> &lt;SUFFIX&gt;</tt><a class="headerlink" href="#cmdoption-pyuic5--resource-suffix" title="Permalink to this definition">¶</a></dt>
...
generated from the resource file by <strong class="program">pyrcc5</strong>.  The default is
...
<p>Note that code generated by <strong class="program">pyuic5</strong> is not guaranteed to be
...
<strong class="program">pyuic5</strong>, or call <a class="reference internal" href="#PyQt5.uic.compileUi" title="PyQt5.uic.compileUi"><tt class="xref py py-func docutils literal"><span class="pre">compileUi()</span></tt></a>, as part of your
...
class must sub-class <a class="reference internal" href="api/qobject.html#PyQt5.QtCore.QObject" title="PyQt5.QtCore.QObject"><tt class="xref py py-class docutils literal"><span class="pre">QObject</span></tt></a> as well as the interface
...
<p>PyQt5 provides the following components and features to resolve these issues as
simply as possible.</p>
<ul>
<li><p class="first">PyQt5&#8217;s QtDesigner module includes additional classes (all of which have a
...
<a class="reference internal" href="api/qobject.html#PyQt5.QtCore.QObject" title="PyQt5.QtCore.QObject"><tt class="xref py py-class docutils literal"><span class="pre">QObject</span></tt></a> and <tt class="docutils literal"><span class="pre">QDesignerCustomWidgetInterface</span></tt>, a
Python custom widget plugin would instead sub-class from
<tt class="xref py py-class docutils literal"><span class="pre">QPyDesignerCustomWidgetPlugin</span></tt>.</p>
</li>
<li><p class="first">PyQt5 installs a C++ plugin in Designer&#8217;s plugin directory.  It conforms to
...
<tt class="xref py py-class docutils literal"><span class="pre">QPyDesignerCustomWidgetPlugin</span></tt>.  Each class that is
...
<a class="reference internal" href="signals_slots.html#PyQt5.QtCore.pyqtSignal" title="PyQt5.QtCore.pyqtSignal"><tt class="xref py py-func docutils literal"><span class="pre">pyqtSignal()</span></tt></a>.</p>
</li>
<li><p class="first">A Python method may be defined as a new Qt slot by using the
<a class="reference internal" href="signals_slots.html#PyQt5.QtCore.pyqtSlot" title="PyQt5.QtCore.pyqtSlot"><tt class="xref py py-func docutils literal"><span class="pre">pyqtSlot()</span></tt></a> decorator.</p>
</li>
<li><p class="first">A new Qt property may be defined using the <a class="reference internal" href="qt_properties.html#PyQt5.QtCore.pyqtProperty" title="PyQt5.QtCore.pyqtProperty"><tt class="xref py py-func docutils literal"><span class="pre">pyqtProperty()</span></tt></a>
function.</p>
</li>
</ul>
...
<tt class="file docutils literal"><span class="pre">examples/designer/plugins</span></tt> directory of the PyQt5 source package.  The
...
<li><a class="reference internal" href="#pyuic5"><strong class="program">pyuic5</strong></a></li>
<li><a class="reference internal" href="#writing-qt-designer-plugins">Writing Qt Designer Plugins</a></li>
  ...
  <p class="topless"><a href="resources.html"
                        title="next chapter">The PyQt5 Resource System</a></p>
